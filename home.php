...
<div id="postform">
    ...
    <div id="homeinfobox">
        <a href="followers.php" style="text-decoration: none;"><?php echo $r->zcard("followers:" . $User['id']) ?>
            followers</a><br>
        <a href="following.php" style="text-decoration: none;"><?php echo $r->zcard("following:" . $User['id']) ?>
            following</a><br>
    </div>
</div>
<?php
